...
const SilverInvestment = sequelize.define('SilverInvestment', {
  id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
  userId: { type: DataTypes.INTEGER, allowNull: false },
  type: { type: DataTypes.ENUM('Physical Silver', 'Silver ETF', 'SilverBees'), allowNull: false },
...
}, { tableName: 'silver_investments' });

module.exports = SilverInvestment;
